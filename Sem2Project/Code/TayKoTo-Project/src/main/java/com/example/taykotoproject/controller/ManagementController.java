...
//        }
    ...
    public String updateDeal(@Valid Deal deal,
        ...
        if (deal.getArriveDate() != null){
            ...
            String date = simpleDateFormat.format(deal.getArriveDate());
            ...
            "Đơn đặt xe của "+customer.getCustomerName()+" sẽ về vào ngày " + date);
        }
...
//        }
    ...
    public String approve(@PathVariable Long id){
        ...
        deal.setDepositDate(Date.valueOf(LocalDate.now()));
        dealService.save(deal);
